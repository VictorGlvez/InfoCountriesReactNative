...
import { countries, correctCountry, options, fetchData } from '../utils/juego.js';
/*
Toda la funcionalidad relacionada con el sonido en el juego se ha dejado inactiva con la posibilidad de ser reactivada en un futuro.
        ...
        >
            <View style={styles.container}>
                <View style={styles.gameContainer}>
                    <Text style={styles.title}>Adivina la bandera</Text>
                    <Text style={styles.roundCounter}>Ronda {round}/10</Text>
                    {correctAnswer.flag && (
                        <Animated.Image
                            style={[styles.flag, { transform: [{ rotate: flagRotationInterpolate }] }]}
                            source={{ uri: correctAnswer.flag }}
                        />
                    )}
